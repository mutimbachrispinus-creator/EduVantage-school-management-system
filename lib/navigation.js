...
export const ALL_NAV = [
  ...
  { key:'fees',        label:'Fees', icon:'💰', roles:['admin', 'admin_finance'] },
  { key:'billing',     label:'Billing', icon:'💳', roles:['admin', 'admin_finance'] },
  { key:'nexed',       label:'Nexed Finance', icon:'🏛️', roles:['admin', 'admin_finance'] },
  { key:'finance/reconcile', label:'Reconciliation', icon:'🏦', roles:['admin', 'admin_finance'] },
  { key:'finance/budgets',   label:'Budgets', icon:'📊', roles:['admin', 'admin_finance'] },
  { key:'finance/petty-cash',label:'Petty Cash', icon:'💵', roles:['admin', 'admin_finance'] },
  { key:'finance/payroll',   label:'Payroll', icon:'💸', roles:['admin', 'admin_finance'] },
