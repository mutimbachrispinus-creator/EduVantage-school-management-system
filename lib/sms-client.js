 ...
 */
export function getResultNotificationMessage(learnerName, termLabel, totalPts, maxPts, schoolName) {
  const prefix = schoolName ? `[${schoolName}]\n` : '';
  return `${prefix}Results Notice\n` +
         `${termLabel} results for ${learnerName} are now available.\n` +
